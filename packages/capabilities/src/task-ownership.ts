export const CAPABILITY_TASK_OWNER_METADATA_KEY = 'unified-mpc.taskOwner.v1';

export const CAPABILITY_ACTIVE_WORKSPACE_ROOT_METADATA_KEY = 'unified-mpc.activeWorkspaceRoot.v1';
