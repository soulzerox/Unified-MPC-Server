...
export const CORE_TOOL_RUNTIME_FIXTURES = {
  ...
  working_memory_record: service({ workspaceId, name: 'goal:smoke', observations: ['smoke progress'] }, 'thaiRag.call:remember', 'workspace_bootstrap'),
  ...
  workspace_memory_record: service({ workspaceId, name: 'goal:smoke', observations: ['smoke progress'], category: 'work-log' }, 'thaiRag.call:remember'),
