...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.61.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.61.0.exe.blockmap
