...
import { CheckpointService, FileService, GitService, ProcessService, ProjectService, ProjectSnapshotService, SearchService, WorkspaceInfoService, WorkspaceQueryService } from '@unified-mpc/application';
import { ok, type CommandSpec, type Result } from '@unified-mpc/domain';
import { ToolRegistry, type McpApplicationServices } from '@unified-mpc/mcp-server';
import { SqliteCheckpointRepository, SqliteDatabase, SqliteWorkspaceRepository } from '@unified-mpc/storage';
import { WorkspaceService } from '@unified-mpc/workspace';
