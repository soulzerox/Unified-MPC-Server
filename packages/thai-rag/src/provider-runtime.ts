...
export type ThaiRagProviderDriverHealth = ThaiRagProviderComponents & Pick<ThaiRagProviderHealth, 'compatibilityRange' | 'contractFingerprint' | 'generation'> & { readonly degradation?: readonly string[] };
