import type { GoalManagedTaskStateReader, ManagedGoalTaskState } from '@unified-mpc/application';
import type { GoalTaskProvider, GoalTrackedTask, Result } from '@unified-mpc/domain';
