import { appError, err, type CommandSpec, type Result } from '@unified-mpc/domain';
import { JsCommandDetector, ProjectDetector, type ProjectCommandKind, type ProjectProfile } from '@unified-mpc/project';
