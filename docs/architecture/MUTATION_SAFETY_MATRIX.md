...
**Covered tools:** `workspace_register`, `workspace_activate`, `workspace_deactivate`, `workspace_set_primary`, `workspace_index`, `workspace_index_watch`, `workspace_index_stop`, `session_handoff`, `verify_incremental`, `recipe_run`, `run_affected_tests`, `cache_clear`, `cache_invalidate`, `hook_register`, `hook_remove`, `plugin_install`, `plugin_enable`, `plugin_disable`, `plugin_remove`, `session_checkpoint`, `ponytail_session`, `rag_remember`, `workspace_memory_record`, `rag_code_index`, `rag_forget`, `project_profile_set`, `tool_schema_register`, `task_create`, `task_cancel`, `delegate`, `delegate_cancel`, `parallel_delegate`, `debug_attach`, `debug_step`, `skills_import`, `skills_install`, `mcp_install`, `agent_swarm_run`.

**Native memory:** `rag_recall`, `rag_remember`, and `workspace_memory_record` use parent-owned Thai-RAG with canonical workspace scope. Selective memory never captures ordinary turns automatically. `rag_code_index` and `rag_forget` remain bounded mutations; generic `mcp_call` remains opaque and independently approval-guarded.
