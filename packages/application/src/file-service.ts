...
import { isProtectedCriticalPath } from '@unified-mpc/shared';
import { isFilesystemRoot, isWithin, WorkspacePathGuard, type ResolvedWorkspacePath, type Workspace, type WorkspaceRepository } from '@unified-mpc/workspace';
