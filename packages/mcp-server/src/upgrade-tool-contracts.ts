...
const FIELD_SCHEMAS = {
  ...
  ref: stringField,
  dependencyInstallMode: z.enum(['frozen', 'mutable']).optional(),
  bootstrapDependencies: booleanField,
  dependencyEmergencyOverride: booleanField,
  dependencyBootstrapTimeoutMs: positiveInt,
...
const INPUT_FIELDS: Readonly<Record<string, readonly FieldName[]>> = Object.freeze({
  ...
  git_worktree_spawn: ['workspaceId', 'worktreePath', 'ref', 'dryRun', 'dependencyInstallMode', 'bootstrapDependencies', 'dependencyEmergencyOverride', 'dependencyBootstrapTimeoutMs', 'timeoutMs'],
