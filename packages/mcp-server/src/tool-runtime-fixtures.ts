...
export const CORE_TOOL_RUNTIME_FIXTURES = {
  ...
  working_memory_search: service({ workspaceId, query: 'current smoke task' }, 'thaiRag.call:recall', 'workspace_bootstrap'),
  working_memory_record: service({ workspaceId, name: 'goal:smoke', observations: ['smoke progress'] }, 'thaiRag.call:record_event', 'workspace_bootstrap'),
  ...
  skills_install: service({ name: 'smoke-skill', source: 'https://github.com/example/smoke-skill.git' }, 'installer.installSkill'),
  ...
  rag_recall: service({ workspaceId, query: 'smoke memory', limit: 3 }, 'thaiRag.call:recall'),
  rag_remember: service({ workspaceId, content: 'smoke durable memory', category: 'smoke' }, 'thaiRag.call:remember'),
  workspace_memory_record: service({ workspaceId, name: 'goal:smoke', observations: ['smoke progress'], category: 'work-log' }, 'thaiRag.call:record_event'),
  rag_forget: service({ workspaceId, memoryId: 'memory-1', userConfirmed: true }, 'thaiRag.call:forget'),
  rag_pre_edit_context: service({ workspaceId, filePath: 'src/smoke.ts', proposedSymbol: 'smoke' }, 'thaiRag.call:pre_edit_context'),
  rag_code_search: service({ workspaceId, query: 'smoke', topK: 3 }, 'thaiRag.call:code_search'),
...
export const PHASE_34_TO_46_TOOL_RUNTIME_FIXTURES = {
  ...
  skills_import: service({ workspaceId, source_path: '.agents/skills/unified-mpc-scheduled-continuation/SKILL.md' }, 'file.readFile'),
